...
macro(ocv_create_module)
  ...
  if (FALSE)
      message(STATUS "--------------------- Module: ${the_module} --------------")
      message(STATUS "Headers-------------:  ${OPENCV_MODULE_${the_module}_HEADERS}")
      message(STATUS "Sources-------------:  ${OPENCV_MODULE_${the_module}_SOURCES}")
      message(STATUS "----------------------------------------------------------")
  endif()

  set_target_properties(${the_module} PROPERTIES FOLDER "3rd_party" LINKER_LANGUAGE CXX)
